...
int main (int argc, char ** argv) 
{
  ...
  if ( splitStat == 0 ) {
    ...
    if(isMiscalib == true && useZ == 1 && isEPselection ==false && isR9selection==false ) name_tmp =Form ("%s_Z_noEP_miscalib_EE",outputFile.c_str());
    ...
    if(isMiscalib == false && useZ == 1 && isEPselection ==false && isR9selection==false ) name_tmp =Form ("%s_Z_noEP_EE",outputFile.c_str());
    ...
    if(isMiscalib == true && useZ == 0 && isEPselection ==false && isR9selection==false ) name_tmp =Form ("%s_noEP_miscalib_EE",outputFile.c_str());
    ...
    if(isMiscalib == false && useZ == 0 && isEPselection ==false && isR9selection==false ) name_tmp =Form ("%s_noEP_EE",outputFile.c_str());
