...
int main(int argc, char**argv){
 ...
 std::string UseMethodFlag  = gConfigParser -> readStringOption("Input::UseMethodFlag");
 
 std::string FilemethodXML_EB_E  = gConfigParser -> readStringOption("Input::FilemethodXMLEBE");
 std::string FilemethodXML_EB_P  = gConfigParser -> readStringOption("Input::FilemethodXMLEBP");

 std::string FilemethodXML_EE_E  = gConfigParser -> readStringOption("Input::FilemethodXMLEEE");
 std::string FilemethodXML_EE_P  = gConfigParser -> readStringOption("Input::FilemethodXMLEEP");


 std::string RegionOfTraining  = gConfigParser -> readStringOption("Input::RegionOfTraining");
 std::string inputFile =  gConfigParser -> readStringOption("Input::inputFile");

 bool useW = gConfigParser -> readBoolOption("Input::useW");
 ...
 TBranch *weightBranchW_1, *weightBranchW_2, *weightBranchZ_1, *weightBranchZ_2, *btargetW_1, *btargetZ_1,*btargetW_2, *btargetZ_2;
