...
void CalibrationEndcap (
 			     Char_t* infile1 = "/data2/deguio/Calibration/SingleEleCalib/FastCalibrator/data_LC_20120131_ALPHA_test_prompt/SingleElectron_Run2011AB-WElectron-data_LC_20120131_ALPHA_test_prompt_EoPcaibEE_11032011_Z_R9_EE.root",
 			     Char_t* infile2 = "/data2/deguio/Calibration/SingleEleCalib/FastCalibrator/data_LC_20120131_ALPHA_test_prompt/Even_SingleElectron_Run2011AB-WElectron-data_LC_20120131_ALPHA_test_prompt_EoPcaibEE_11032011_Z_R9_EE.root",
 			     Char_t* infile3 = "/data2/deguio/Calibration/SingleEleCalib/FastCalibrator/data_LC_20120131_ALPHA_test_prompt/Odd_SingleElectron_Run2011AB-WElectron-data_LC_20120131_ALPHA_test_prompt_EoPcaibEE_11032011_Z_R9_EE.root",
...
//     
 ...
 TFile* input = new TFile("output/MomentumCalibration.root");
...
for( int i=0; i<PhiProjectionEEm->GetN(); i++){
 ...
 /// spread all distribution, spread for EE+ and EE- 
  ...
  if (evalStat){
    cEEP[5] = new TCanvas("cstatP","cstatP");
    cEEP[5]->SetGridx();
    cEEP[5]->SetGridy();
    ...
    cEEP[7] = new TCanvas("csigmaFolded","csigmaFolded");
    cEEP[7]->SetGridx();
    cEEP[7]->SetGridy();
    ...
    cEEP[8] = new TCanvas("cresidualFolded","cresidualFolded");
    cEEP[8]->SetGridx();
    cEEP[8]->SetGridy();
   ...
   cEEM[8] = new TCanvas("PhiProjectionEEM","PhiProjectionEEM");
   cEEM[8]->SetGridx();
   cEEM[8]->SetGridy();
   ...
   cEEP[8] = new TCanvas("PhiProjectionEEP","PhiProjectionEEP");
   cEEP[8]->SetGridx();
   cEEP[8]->SetGridy();
   ...
   cAll[0]= new TCanvas("PhiProjectionSame","PhiProjectionSame");
   cAll[0]->SetGridx();
   cAll[0]->SetGridy();
   PhiProjectionEEp->Draw("apl");
   ...
   /// Map corrected
   cEEM[9] = new TCanvas("cmapCorrectedEEM","cmapCorrectedEEM");
   cEEM[9] -> cd();
   cEEM[9]->SetLeftMargin(0.1); 
   cEEM[9]->SetRightMargin(0.13); 
   cEEM[9]->SetGridx();
   cEEM[9]->SetGridy();
   mapMomentumCorrected[9]->GetXaxis() -> SetLabelSize(0.03);
   ...
   cEEP[9] = new TCanvas("cmapCorrectedEEP","cmapCorrectedEEP");
   cEEP[9] -> cd();
   cEEP[9]->SetLeftMargin(0.1); 
   cEEP[9]->SetRightMargin(0.13); 
   cEEP[9]->SetGridx();
   cEEP[9]->SetGridy();
   ...
   cEEM[10] = new TCanvas("PhiProjectionEEM_Corrected","PhiProjectionEEM_Corrected");
   cEEM[10]->SetGridx();
   cEEM[10]->SetGridy();
   ...
   cEEP[10] = new TCanvas("PhiProjectionEEP_Corrected","PhiProjectionEEP_Corrected");
   cEEP[10]->SetGridx();
   cEEP[10]->SetGridy();
   ...
   cAll[1] = new TCanvas("PhiProjectionSame_Corrected","PhiProjectionSame_Corrected");
   cAll[1]->SetGridx();
   cAll[1]->SetGridy();
   PhiProjectionEEp_Corrected->Draw("apl");
   ...
   cAll[2] = new TCanvas("ProfileEEm","ProfileEEm");
   cAll[2]->SetGridx();
   cAll[2]->SetGridy();
   ...
   cAll[3] = new TCanvas("ProfileEEp","ProfileEEp");
   cAll[3]->SetGridx();
   cAll[3]->SetGridy();
   ...
   /// new Precision and residual:
    ...
    cEEP[11] = new TCanvas("csigmaFoldedCorrected","csigmaFoldedCorrected");
    cEEP[11]->SetGridx();
    cEEP[11]->SetGridy();
    ...
    cEEP[8] = new TCanvas("cresidualFoldedCorrected","cresidualFoldedCorrected");
    cEEP[8]->SetGridx();
    cEEP[8]->SetGridy();
  ...
  cEEP[11] = new TCanvas("Warning_EEP","Warning_EEP");
  cEEP[11]->SetGridx();
  cEEP[11]->SetGridy();
  ...
  cEEM[11] = new TCanvas("Warning_EEM","Warning_EEM");
  cEEM[11]->SetGridx();
  cEEM[11]->SetGridy();
