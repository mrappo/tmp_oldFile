...
void CombineMomentumCalibration(){
  ...
  TFile *f1 = TFile::Open("output/MomentumCalibrationTest.root");
  TFile *f2 = TFile::Open("output/MomentumCalibrationTest2011.root");
  TFile *f3 = new TFile("output/MomentumCalibrationCombined.root","RECREATE");
  f3->cd();
  ...
  if(g_EoC_EB_1==0 && g_EoC_EB_2==0) break;
  ...
  TH1F *hPad_EB = (TH1F*)gPad->DrawFrame(0.,0.95,phiLim,1.07);
...
//   g_Corr_EB -> Draw("PL");
  ...
  //  tl -> SetBorderSize(0); 
  tl_EB -> AddEntry(g_EoC_EB_1,"Data 2012 EB","PL");
  tl_EB -> AddEntry(g_EoC_EB_2,"Data 2011 EB","PL");
//   tl_EB -> AddEntry(g_Corr_EB,"2011-2012 Combined","PL");
  ...
  TH1F *hRat_EB = (TH1F*)gPad->DrawFrame(0.,-0.01,phiLim,0.01);
 ...
 while (f1!=0 && f2!=0) {
  ...
  if(g_EoC_EE_1==0 && g_EoC_EE_2==0 && g_Rat_EE==0) break;
  ...
  cUpper_EE -> cd();
  gPad->SetGrid();
  TH1F *hPad_EE = (TH1F*)gPad->DrawFrame(0.,0.95,phiLim,1.07);
...
//   g_Corr_EE -> Draw("PL");
  ...
  //  tl -> SetBorderSize(0); 
  tl_EE -> AddEntry(g_EoC_EE_1,"Data 2012 EE","PL");
  tl_EE -> AddEntry(g_EoC_EE_2,"Data 2011 EE","PL");
//   tl_EE -> AddEntry(g_Corr_EE,"2011-2012 Combination EE","PL");
  ...
  TH1F *hRat_EE = (TH1F*)gPad->DrawFrame(0.,-0.02,phiLim,0.02);
