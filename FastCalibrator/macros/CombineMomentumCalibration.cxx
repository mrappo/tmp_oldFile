...
void CombineMomentumCalibration()
{
  ...
  std::cout << "*** EB_1 yScale: " << yAvg_EB_1 << std::endl;
  ...
  std::cout << "*** EB_2 yScale: " << yAvg_EB_2 << std::endl;
  ...
  {  
    ...
    std::cout << "*** EE_" << i << "_1 yScale: " << yAvg_EE_1 << std::endl;
    ...
    std::cout << "*** EE_" << i << "_2 yScale: " << yAvg_EE_2 << std::endl;
