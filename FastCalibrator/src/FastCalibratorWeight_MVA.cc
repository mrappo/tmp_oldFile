#include "FastCalibratorWeight_MVA.h"
...
FastCalibratorWeight_MVA::FastCalibratorWeight_MVA(TTree *tree,TString outEPDistribution):
...
FastCalibratorWeight_MVA::~FastCalibratorWeight_MVA(){
  if (!fChain) return;
...
Int_t FastCalibratorWeight_MVA::GetEntry(Long64_t entry){
  if (!fChain) return 0;
...
Long64_t FastCalibratorWeight_MVA::LoadTree(Long64_t entry){
...
void FastCalibratorWeight_MVA::Init(TTree *tree){
...
Bool_t FastCalibratorWeight_MVA::Notify(){
...
void FastCalibratorWeight_MVA::Show(Long64_t entry){
...
Int_t FastCalibratorWeight_MVA::Cut(Long64_t entry){
...
void FastCalibratorWeight_MVA::bookHistos(int nLoops){
...
void FastCalibratorWeight_MVA::BuildWeightDistribution_ele(int iLoop, int nentries , int useW, int useZ,std::vector<float> theScalibration,bool isR9selection){
...
void FastCalibratorWeight_MVA::BuildEoPeta_ele(int iLoop, int nentries , int useW, int useZ, std::vector<float> theScalibration,bool isSaveEPDistribution,bool isR9selection, bool isMCTruth){
...
void FastCalibratorWeight_MVA::Loop(int nentries, int useZ, int useW, int splitStat, int nLoops, bool isMiscalib,bool isSaveEPDistribution,bool isEPselection,bool isR9selection, bool isMCTruth)
{
   if (fChain == 0) return;
...
void FastCalibratorWeight_MVA::saveHistos(TFile * f1){
...
void FastCalibratorWeight_MVA::saveEoPeta(TFile * f2){
 f2->cd();
...
void FastCalibratorWeight_MVA::AcquireDeadXtal(TString inputDeadXtal){
...
bool FastCalibratorWeight_MVA::CheckDeadXtal(const int & iEta, const int & iPhi){
  int hashed_Index;
