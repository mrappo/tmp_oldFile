...
class QGLikelihoodCalculator {
 ...
 public:
  ...
  QGLikelihoodCalculator( const std::string& fileName="/gwpool/users/benaglia/COLLISIONS7TeV/Fall10/NtuplePackage/data/QG_QCD_Pt_15to3000_TuneZ2_Flat_7TeV_pythia6_Spring11-PU_S1_START311_V1G1-v1.root", unsigned nPtBins=20, unsigned int nRhoBins=17 );
