      ...
      for($iRS = 0 ; $iRS < @Rinormalization_scale ; $iRS++)
        {
         ...
         $command2 =  "cat ".$BaseDir.$CFG_Template."   | sed -e s%SEEDFIXME%".$random_number.                                                                                      "%g | sed -e s%DiagramType%".@DiagramMode[1].
          ...
          $command = "bsub -cwd ./LSF -q 1nw \"cd \$PWD ; ./mcfm ".$BaseDir."/".$fileName."\"\n" ; 
         ...
         $command = "bsub -cwd ./LSF  -q 2nw \"cd \$PWD ; ./mcfm ".$BaseDir."/".$fileName."\"\n" ; 
          
         print $command ;
         system ($command) ;

         $command_2 = "bsub -cwd ./LSF  -q 2nw \"cd \$PWD ; ./mcfm ".$BaseDir."/".$fileName_2."\"\n" ; 
