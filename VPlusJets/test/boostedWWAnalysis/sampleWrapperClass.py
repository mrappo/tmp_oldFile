...
class sampleWrapperClass:
    ...
    def createBRDTree(self):
        ...
        mass_lvj_type0_met_   = array( 'f', [ 0. ] );
        mass_lvj_type1_met_   = array( 'f', [ 0. ] );
        mass_lvj_type2_met_   = array( 'f', [ 0. ] );
        mass_lvj_type3_met_   = array( 'f', [ 0. ] );

        v_mass_type0_met_    = array( 'f', [ 0. ] );
        v_mass_type1_met_    = array( 'f', [ 0. ] );
        v_mass_type2_met_    = array( 'f', [ 0. ] );
        v_mass_type3_met_    = array( 'f', [ 0. ] );
        ...
        deltaphi_METca8jet_met_  = array( 'f', [0.] );
        deltaphi_Vca8jet_met_    = array( 'f', [0.] );
        ...
        otree.Branch("W_pt_gen", W_pt_gen_ , "W_pt_gen/F");
        ...
        otree.Branch("mass_lvj_type0_met", mass_lvj_type0_met_ , "mass_lvj_type0_met/F");
        otree.Branch("mass_lvj_type1_met", mass_lvj_type1_met_ , "mass_lvj_type1_met/F");
        otree.Branch("mass_lvj_type2_met", mass_lvj_type2_met_ , "mass_lvj_type2_met/F");
        otree.Branch("mass_lvj_type3_met", mass_lvj_type3_met_ , "mass_lvj_type3_met/F");
        ...
        otree.Branch("v_mass_type0_met", v_mass_type0_met_ , "v_mass_type0_met/F");
        otree.Branch("v_mass_type1_met", v_mass_type1_met_ , "v_mass_type1_met/F");
        otree.Branch("v_mass_type2_met", v_mass_type2_met_ , "v_mass_type2_met/F");
        otree.Branch("v_mass_type3_met", v_mass_type3_met_ , "v_mass_type3_met/F");
        ...
        otree.Branch("jet_tobec_filter", jet_tobec_filter_ , "jet_tobec_filter/I");
        ...
        otree.Branch("l_charge", l_charge_ , "l_charge/F");
        ...
        otree.Branch("deltaphi_METca8jet_met", deltaphi_METca8jet_met_, "deltaphi_METca8jet_met/F");
        otree.Branch("deltaphi_Vca8jet_met", deltaphi_Vca8jet_met_, "deltaphi_Vca8jet_met/F");
...
#                    print " AK5 pt ",getattr( self.InputTree_, "GroomedJet_AK5_pt" )[i]
                    ...
                    if getattr( self.InputTree_, "GroomedJet_AK5_pt" )[i] > 30:
                        ...
                        j_ak5_phi = getattr( self.InputTree_, "GroomedJet_AK5_phi" )[i]
                        l_eta = getattr( self.InputTree_, "W_"+lepLabel+"_eta" )
                        l_phi = getattr( self.InputTree_, "W_"+lepLabel+"_phi" )                
            ...
            signallike = 0;
            if getattr( self.InputTree_, "W_pt" ) > 200 and getattr( self.InputTree_, "GroomedJet_CA8_pt" )[0] > 200 and getattr( self.InputTree_, "event_met_pfmet" ) > metCut and getattr( self.InputTree_, leptonCutString ) > leptonCut and getattr( self.InputTree_, "GroomedJet_CA8_deltaR_lca8jet") > 1.57 and getattr( self.InputTree_, "GroomedJet_CA8_deltaphi_METca8jet_type2_met") > 2.0:
...
#            print "W_pt ",getattr( self.InputTree_, "W_pt" ),"GroomedJet_CA8_pt ",getattr( self.InputTree_, "GroomedJet_CA8_pt" )[0]," pfMET ",getattr( self.InputTree_, "event_met_pfmet" )," pt ",getattr( self.InputTree_, leptonCutString )," GroomedJet_CA8_deltaR_lca8jet ",getattr( self.InputTree_, "GroomedJet_CA8_deltaR_lca8jet")," GroomedJet_CA8_deltaphi_METca8jet ",getattr( self.InputTree_, "GroomedJet_CA8_deltaphi_METca8jet") 
#            print " issignallike ",signallike                  
            signallike_exo_ = 0;
...
#                if False:                    
             ...
             ###################################
             # make training tree
             mass_lvj_[0] = getattr( self.InputTree_, "boostedW_lvj_m_type2_met" );
             ...
             if self.IsData_ == False  :
                 ...
                 if self.Channel_ == "mu" and self.IsData_ == False:
                     W_Lepton_gen.SetPxPyPzE(getattr(self.InputTree_, "W_muon_px_gen" )+getattr(self.InputTree_, "W_neutrino_px_gen"),getattr(self.InputTree_, "W_muon_py_gen" )+getattr(self.InputTree_, "W_neutrino_py_gen" ),getattr(self.InputTree_, "W_muon_pz_gen" )+getattr(self.InputTree_, "W_neutrino_pz_gen" ),getattr(self.InputTree_, "W_muon_e_gen" )+getattr(self.InputTree_, "W_neutrino_e_gen" ));

                 if self.Channel_ == "el" and self.IsData_ == False:
                     W_Lepton_gen.SetPxPyPzE(getattr(self.InputTree_, "W_electron_px_gen" )+getattr(self.InputTree_, "W_neutrino_px_gen"),getattr(self.InputTree_, "W_electron_py_gen" )+getattr(self.InputTree_, "W_neutrino_py_gen" ),getattr(self.InputTree_, "W_electron_pz_gen" )+getattr(self.InputTree_, "W_neutrino_pz_gen" ),getattr(self.InputTree_, "W_electron_e_gen" )+getattr(self.InputTree_, "W_neutrino_e_gen" ));

                 W_pt_gen_[0] = getattr( self.InputTree_, "W_pt" ) ;
                 if(W_Lepton_gen.E() > 7000) : W_pt_gen_[0]  =  W_Lepton_gen.Pt();
                 
                 #print " W_pt_gen_[0] ",W_pt_gen_[0]," W_pt ",getattr( self.InputTree_, "W_pt" )," W_electron_pt_gen ",getattr(self.InputTree_, "W_electron_pt_gen" )," eta ",getattr(self.InputTree_, "W_electron_eta_gen" ) , " phi ",getattr(self.InputTree_, "W_electron_phi_gen" )," e ",getattr(self.InputTree_, "W_electron_e_gen" ) ;
             ...
             mass_lvj_type0_met_[0]   = getattr( self.InputTree_, "boostedW_lvj_m_type0_met" );
             mass_lvj_type1_met_[0]   = getattr( self.InputTree_, "boostedW_lvj_m_type1_met" );
             mass_lvj_type2_met_[0]   = getattr( self.InputTree_, "boostedW_lvj_m_type2_met" );
             mass_lvj_type3_met_[0]   = getattr( self.InputTree_, "boostedW_lvj_m_type3_met" );

#             print " mass no met : ",mass_lvj_type0_[0],"  ",mass_lvj_type1_[0],"  ",mass_lvj_type2_[0],"  ",mass_lvj_type3_[0] ;
#             print " mass    met : ",mass_lvj_type0_met_[0],"  ",mass_lvj_type1_met_[0],"  ",mass_lvj_type2_met_[0],"  ",mass_lvj_type3_met_[0] ;

             v_mass_type0_met_[0]    = getattr( self.InputTree_, "W_mass_type0_met" );
             v_mass_type1_met_[0]    = getattr( self.InputTree_, "W_mass_type1_met" );
             v_mass_type2_met_[0]    = getattr( self.InputTree_, "W_mass_type2_met" );
             v_mass_type3_met_[0]    = getattr( self.InputTree_, "W_mass_type3_met" );
             ...
             if self.Channel_ == "mu" :
                    ...
                    l_charge_[0] = getattr( self.InputTree_, "W_muon_charge" );
                    ...
                    l_charge_[0] = getattr( self.InputTree_, "W_electron_charge" );
             ...
             nbjets_csvl_veto_cleaned_[0]   = getattr( self.InputTree_, "GroomedJet_numberbjets_csvl" );
             nbjets_csvm_veto_cleaned_[0]   = getattr( self.InputTree_, "GroomedJet_numberbjets_csvm" );
             nbjets_ssvhem_veto_cleaned_[0] = getattr( self.InputTree_, "GroomedJet_numberbjets_ssvhem" );
             ...
             #print " btag build inside ",nbjets_csvm_veto_[0]," in the RD Tree ",nbjets_csvm_veto_cleaned_[0]
             ...
             deltaphi_METca8jet_met_[0] = getattr( self.InputTree_, prefix + "_deltaphi_METca8jet_type2_met" );       
             deltaphi_Vca8jet_met_[0] = getattr( self.InputTree_, prefix + "_deltaphi_Vca8jet_type2_met" );       

              #print " delta phi nomet : ",deltaphi_METca8jet_met_[0]," met : ",deltaphi_Vca8jet_met_[0] ;
    ...
    def turnOffBranches(self):
        ...
        if self.Channel_ == "mu" :
            ...
            self.InputTree_.SetBranchStatus("W_muon_charge",1);
            ...
            self.InputTree_.SetBranchStatus("W_electron_charge",1);
        ...
        self.InputTree_.SetBranchStatus("boostedW_lvj_m_type0_met",1);
        self.InputTree_.SetBranchStatus("boostedW_lvj_m_type1_met",1);
        self.InputTree_.SetBranchStatus("boostedW_lvj_m_type2_met",1);
        self.InputTree_.SetBranchStatus("boostedW_lvj_m_type3_met",1);
        ...
        self.InputTree_.SetBranchStatus("GroomedJet_CA8_deltaphi_METca8jet_type2",1);
        ...
        self.InputTree_.SetBranchStatus("W_mass_type0_met",1);
        self.InputTree_.SetBranchStatus("W_mass_type1_met",1);
        self.InputTree_.SetBranchStatus("W_mass_type2_met",1);
        self.InputTree_.SetBranchStatus("W_mass_type3_met",1);
        ...
        self.InputTree_.SetBranchStatus(prefix + "_tobecFlag",1);        
        ...
        self.InputTree_.SetBranchStatus(prefix + "_jetcharge",1);
        ...
        self.InputTree_.SetBranchStatus(prefix + "_deltaphi_METca8jet_type2_met",1);
        self.InputTree_.SetBranchStatus(prefix + "_deltaphi_Vca8jet_type2_met",1);
        ...
        self.InputTree_.SetBranchStatus("W_neutrino_eta_gen",1)
        self.InputTree_.SetBranchStatus("W_neutrino_phi_gen",1)
        self.InputTree_.SetBranchStatus("W_neutrino_pt_gen",1)
        ...
        if self.Channel_ == "el":
            ...
            self.InputTree_.SetBranchStatus("W_electron_eta_gen",1)
            self.InputTree_.SetBranchStatus("W_electron_phi_gen",1)
            self.InputTree_.SetBranchStatus("W_electron_pt_gen",1)
        if self.Channel_ == "mu":
            ...
            self.InputTree_.SetBranchStatus("W_muon_eta_gen",1)
            self.InputTree_.SetBranchStatus("W_muon_phi_gen",1)
            self.InputTree_.SetBranchStatus("W_muon_pt_gen",1)
