...
if __name__ == '__main__':
    ...
    sourcefiledirectory = "/data2/rgerosa/SideBandClosureTest/RD_Trees/GR_P_V39_AN3/";    
    outputfiledirectory = "/data2/rgerosa/SideBandClosureTest/otrees_GR_P_V39_AN3/";    

    # ---------------------------------------------------
    # check if directories exists
    print "mkdir "+outputfiledirectory+"trainingtrees_mu" 
    ...
    datasample_1 = sampleWrapperClass("data_194712_559_405404310",boostedWSamples.GetFileNames()["data_194712_559_405404310"],CHANNEL,LUMI,LUMI,boostedWSamples.GetTreeName(),isData,outputfiledirectory)

    datasample_2 = sampleWrapperClass("data_204544_102_152417542",boostedWSamples.GetFileNames()["data_204544_102_152417542"],CHANNEL,LUMI,LUMI,boostedWSamples.GetTreeName(),isData,outputfiledirectory)

    datasample_3 = sampleWrapperClass("data_195930_83_62880579",boostedWSamples.GetFileNames()["data_195930_83_62880579"],CHANNEL,LUMI,LUMI,boostedWSamples.GetTreeName(),isData,outputfiledirectory)

    datasample_4 = sampleWrapperClass("data_208487_118_209515269",boostedWSamples.GetFileNames()["data_208487_118_209515269"],CHANNEL,LUMI,LUMI,boostedWSamples.GetTreeName(),isData,outputfiledirectory)

#    datasample_5 = sampleWrapperClass("data_195013_114_117238404",boostedWSamples.GetFileNames()["data_195013_114_117238404"],CHANNEL,LUMI,LUMI,boostedWSamples.GetTreeName(),isData,outputfiledirectory)

#    datasample_6 = sampleWrapperClass("data_195948_317_517532532",boostedWSamples.GetFileNames()["data_195948_317_517532532"],CHANNEL,LUMI,LUMI,boostedWSamples.GetTreeName(),isData,outputfiledirectory)

#    datasample_7 = sampleWrapperClass("data_202016_935_952022882",boostedWSamples.GetFileNames()["data_202016_935_952022882"],CHANNEL,LUMI,LUMI,boostedWSamples.GetTreeName(),isData,outputfiledirectory)

#    datasample_8 = sampleWrapperClass("data_195397_899_1123713321",boostedWSamples.GetFileNames()["data_195397_899_1123713321"],CHANNEL,LUMI,LUMI,boostedWSamples.GetTreeName(),isData,outputfiledirectory)

#    datasample_9 = sampleWrapperClass("data_201278_532_72515017",boostedWSamples.GetFileNames()["data_201278_532_72515017"],CHANNEL,LUMI,LUMI,boostedWSamples.GetTreeName(),isData,outputfiledirectory)

#    datasample_10 = sampleWrapperClass("data_202973_241_260228320",boostedWSamples.GetFileNames()["data_202973_241_260228320"],CHANNEL,LUMI,LUMI,boostedWSamples.GetTreeName(),isData,outputfiledirectory)

#    datasample_11 = sampleWrapperClass("data_195655_60_73510965",boostedWSamples.GetFileNames()["data_195655_60_73510965"],CHANNEL,LUMI,LUMI,boostedWSamples.GetTreeName(),isData,outputfiledirectory)

#    datasample_12 = sampleWrapperClass("data_201602_497_68268345",boostedWSamples.GetFileNames()["data_201602_497_68268345"],CHANNEL,LUMI,LUMI,boostedWSamples.GetTreeName(),isData,outputfiledirectory)
    ...
    allSamples = [datasample,datasample_1,datasample_2,datasample_3,datasample_4,
                  #datasample_5,datasample_6,datasample_7,datasample_8,datasample_9,datasample_10,datasample_11,datasample_12,
